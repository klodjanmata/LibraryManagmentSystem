...
public class Menu {
    ...
    public static void Menu() {
        ...
        System.out.println("10. Print All Borrow Records");
        System.out.println("11. Filter by Menu");
        System.out.println("0. Shut down");
    }

    public static void filterMenu(BookActions bookActions, AuthorActions authorActions, GenreRepository genreRepo) {
        System.out.println("\n--- Filter Menu ---");
